							...
							<div class="col-md-4 coach1">
								<div class="btn-group-vertical left" role="group" aria-label="...">
									<%
										a = rs.getInt(5);
									%>
									<button class="btn btn-success" id="ac2" onclick="<%ps.setString(1, cid);
										ps.setInt(2, a);
										ps.addBatch();%>"><%=a%>
									</button>
									<%
										...
										a = rs.getInt(5);
									%>
									<button class="btn btn-danger" id="ac2" onclick="<%ps.setString(1, cid);
										ps.setInt(2, a);
										ps.addBatch();%>"><%=a%>
									</button>
								</div>
								...
								<%
									...
									a = rs.getInt(5);
								%>
								<button class="btn btn-info bottom-right" id="ac2" onclick="<%ps.setString(1, cid);
									ps.setInt(2, a);
									ps.addBatch();%>"><%=a%>
								</button>
								...
								<%
									...
									a = rs.getInt(5);
								%>
								<button class="btn btn-warning bottom-left" id="ac2" onclick="<%ps.setString(1, cid);
									ps.setInt(2, a);
									ps.addBatch();%>"><%=a%>
								</button>
							</div>
							<%
								if (rs.getString(5).equals("54")) {
									break;
								}
								rs.next();
							}
